<div id="st-container" class="st-container">
	...
	<nav class="st-menu st-effect-1" id="menu-1" style="background-color: #6281BF;">
		...
		<ul>
			...
			<!-- <li><a  href="schedule"><span class="glyphicon glyphicon-send"></span> Schedule Management</a></li> -->
			<li><a  href="addBigGroup"><span class="glyphicon glyphicon-list-alt"></span> Group Management</a></li>
			<li><a  href="yourPost"><span class="glyphicon glyphicon-list"></span> All Post</a></li>
			<li><a  href="yourNotifications"><span class="glyphicon glyphicon-align-justify"></span> All Notifications</a></li>
			<!-- <li><a  href="intruduce"><span class="glyphicon glyphicon-envelope"></span> Introduce</a></li> -->
