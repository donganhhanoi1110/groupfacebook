...
<body>
	...
	<div id="cover_all">
		...
		<div id="cover_content">
			...
			<!-- end_negative_left -->
			<div id="content">
				<form:form id="formEditBigGroup" modelAttribute="bigGroupFace" action="editBigGroup"
							...
							<div class="panel-body">
								<div class="col-lg-12">
									<input type="hidden" name="${_csrf.parameterName}"
										value="${_csrf.token}" />
									<form:input path="idBigGroupFace" value="${bigGroupFace.idBigGroupFace }"
											placeholder="Id of group" type="text" class="myhide form-control" />
									<div class="form-group has-warning">
										<form:input path="nameBigGroupFace" value="${bigGroupFace.nameBigGroupFace }"
									...
									<input type="submit" class="btn btn-primary" style="float:right;" id="postEditBigGroup" value="Edit Group"/>
									</div>
											...
											<table id="mytable2">
												...
												<tbody>
													<c:forEach var="group" items="${groups}">
															<c:choose>
																<c:when test="${group.edited == true}">
																<tr>
																	<td><input  checked="checked" type="checkbox" class="checkbox1"
																		name="names" value="${group.idGroupFace}" /></td>
																	<td><img
																		src="http://graph.facebook.com/<c:out value="${group.idGroupFace}"/>/picture"
																		align="middle" /></td>
																	<td><a href="group?id=${group.idGroupFace}"><c:out value="${group.nameGroupFace}" /></a></td>
																</tr>
																</c:when>
																<c:otherwise >
																<tr>
	...
	<div class="modal fade" id="uploadFile" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<label id="resultUpload" class="myResult control-label"><img class="img-responsive img-rectangle mypicture" src="${bigGroupFace.uploadedFile.path }" /></label>
